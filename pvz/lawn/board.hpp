...
public:
	...
	void							InitLevel();
	void							DisplayAdvice(const PopString& theAdvice, MessageStyle theMessageStyle, AdviceType theHelpIndex);
	void							StartLevel();
	...
	/*inline*/ void					DisplayAdviceAgain(const PopString& theAdvice, MessageStyle theMessageStyle, AdviceType theHelpIndex);
