...
//0x51A530
void ToolTipWidget::GetLines(std::vector<PopString>& theLines)
{
	int aLineWidth = 0;
	...
	while (aIndexInLine != mLabel.size())
	{
		...
		{
			PopString aLine = mLabel.substr(aIndexStart, aIndexInLine - aIndexStart);
			aLineWidth = 0;
...
//0x51A8D0
void ToolTipWidget::SetLabel(const PopString& theLabel)
{
...
//0x51A950
void ToolTipWidget::SetTitle(const PopString& theTitle)
{
...
//0x51A9D0
void ToolTipWidget::SetWarningText(const PopString& theWarningText)
{
