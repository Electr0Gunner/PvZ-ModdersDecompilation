...
//0x51C760
UserDialog::UserDialog(LawnApp* theApp) : LawnDialog(theApp, Dialogs::DIALOG_USERDIALOG, true, "WHO ARE YOU?"/*[WHO_ARE_YOU]*/, "", "", Dialog::BUTTONS_OK_CANCEL)
{
...
//0x51CE10
PopString UserDialog::GetSelName()
{
...
void UserDialog::FinishRenameUser(const PopString& theNewName)
{
...
//0x51D060
void UserDialog::EditWidgetText(int theId, const PopString& theString)
{
    mApp->ButtonDepress(mId + 2000);
}

//0x51D080
bool UserDialog::AllowChar(int theId, PopChar theChar)
{
