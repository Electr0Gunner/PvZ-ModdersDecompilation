...
public:
	LawnDialog(LawnApp* theApp, int theId, bool isModal, const PopString& theDialogHeader, const PopString& theDialogLines, const PopString& theDialogFooter, int theButtonMode);
	~LawnDialog();
...
public:
	GameOverDialog(const PopString& theMessage, bool theShowChallengeName);
