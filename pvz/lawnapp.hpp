...
public:
	...
	PopString						mCrazyDaveMessageText;							//+0x854
...
public:
	...
	void							DoConfirmDeleteUserDialog(const PopString& theName);
	void							FinishConfirmDeleteUserDialog(bool isYes);
	void							DoRenameUserDialog(const PopString& theName);
	void							FinishRenameUserDialog(bool isYes);
	void							FinishNameError(int theId);
	void							FinishRestartConfirmDialog();
	void							DoConfirmSellDialog(const PopString& theMessage);
	void							DoConfirmPurchaseDialog(const PopString& theMessage);
	...
	virtual Dialog*					DoDialog(int theDialogId, bool isModal, const PopString& theDialogHeader, const PopString& theDialogLines, const PopString& theDialogFooter, int theButtonMode);
	virtual Dialog*					DoDialogDelay(int theDialogId, bool isModal, const PopString& theDialogHeader, const PopString& theDialogLines, const PopString& theDialogFooter, int theButtonMode);
	virtual void					Shutdown();
	virtual void					Init();
	virtual void					Start();
	virtual Dialog*					NewDialog(int theDialogId, bool isModal, const PopString& theDialogHeader, const PopString& theDialogLines, const PopString& theDialogFooter, int theButtonMode);
	...
	static PopString				GetStageString(int theLevel);
	...
	PopString						GetCrazyDaveText(int theMessageIndex);
	...
	void							CrazyDaveTalkMessage(const PopString& theMessage);
	void							CrazyDaveLeave();
	...
	int								LawnMessageBox(int theDialogId, const PopChar* theHeaderName, const PopChar* theLinesName, const PopChar* theButton1Name, const PopChar* theButton2Name, int theButtonMode);
	virtual void					EnforceCursor();
	void							ShowCreditScreen();
	void							KillCreditScreen();
	static PopString				Pluralize(int theCount, const PopChar* theSingular, const PopChar* thePlural);
	...
	static PopString				GetMoneyString(int theAmount);
	...
	inline PopString				GetCurrentLevelName() { return "Unknown"; }
...
extern PopString (*gGetCurrentLevelName)();
