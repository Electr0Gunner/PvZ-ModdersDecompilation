...
extern bool (*gExtractResourcesByName)(PopLib::ResourceManager* theResourceManager, const char* theName);

extern void* gResources[(int)PopLib::ResourceId::RESOURCE_ID_MAX];
