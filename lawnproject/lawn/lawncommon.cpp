...
LawnEditWidget* CreateEditWidget(int theId, EditListener* theListener, Dialog* theDialog)
{
    ...
    aEditWidget->SetFont(PopLib::FONT_BRIANNETOD16);
...
{
    Checkbox* aCheckbox = new Checkbox(PopLib::IMAGE_OPTIONS_CHECKBOX0, PopLib::IMAGE_OPTIONS_CHECKBOX1, theId, theListener);
