...
//0x45C890
void NewOptionsDialog::AddedToManager(PopLib::WidgetManager* theWidgetManager)
{
...
//0x45C930
void NewOptionsDialog::RemovedFromManager(PopLib::WidgetManager* theWidgetManager)
{
...
//0x45CB50
void NewOptionsDialog::Draw(PopLib::Graphics* g)
{
    ...
    PopLib::Color aTextColor(107, 109, 145);
...
//0x45D290
void NewOptionsDialog::KeyDown(PopLib::KeyCode theKey)
{
    if (mApp->mBoard)
    {
...
void NewOptionsDialog::ButtonDepress(int theId)
{
    ...
    case NewOptionsDialog::NewOptionsDialog_Restart:
    {
        if (mApp->mBoard)
        {
            PopString aDialogTitle;
            PopString aDialogMessage;
            ...
            aDialog->mLawnYesButton->mLabel = TodStringTranslate("RESTART"/*[RESTART_LABEL]*/);
