...
ContinueDialog::ContinueDialog(LawnApp* theApp) : LawnDialog(
	...
	true, 
	"CONTINUE GAME?"/*[CONTINUE_GAME_HEADER]*/,
	"", 
	...
	Dialog::BUTTONS_FOOTER)
{
    ...
    {
        mDialogLines = "Do you want to continue your current game or restart the level?"/*[CONTINUE_GAME_OR_RESTART]*/;
        mContinueButton = MakeButton(ContinueDialog::ContinueDialog_Continue, this, "Continue"/*[CONTINUE_BUTTON]*/);
        mNewGameButton = MakeButton(ContinueDialog::ContinueDialog_NewGame, this, "Restart Level"/*[RESTART_BUTTON]*/);
    }
    else
    {
        mDialogLines = "Do you want to continue your current game or start a new game?"/*[CONTINUE_GAME]*/;
        mContinueButton = MakeButton(ContinueDialog::ContinueDialog_Continue, this, "Continue"/*[CONTINUE_BUTTON]*/);
        mNewGameButton = MakeButton(ContinueDialog::ContinueDialog_NewGame, this, "New Game"/*[NEW_GAME_BUTTON]*/);
    }
    ...
    else if (theId == ContinueDialog::ContinueDialog_NewGame)
    {
        if (mApp->IsAdventureMode())
        {
            LawnDialog* aDialog = (LawnDialog*)mApp->DoDialog(
                ...
                true, 
                "Restart Level?"/*[RESTART_LEVEL_HEADER]*/,
                "Are you sure that you want to restart the level?"/*[RESTART_LEVEL]*/,
                "", 
        ...
        else
        {
            LawnDialog* aDialog = (LawnDialog*)mApp->DoDialog(
                Dialogs::DIALOG_RESTARTCONFIRM, 
                true, 
                "New Game?"/*[NEW_GAME_HEADER]*/,
                "Are you sure that you want to start a new game?"/*[NEW_GAME]*/,
                "", 
                Dialog::BUTTONS_OK_CANCEL
            );
