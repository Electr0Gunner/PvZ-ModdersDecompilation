...
TitleScreen::TitleScreen(LawnApp* theApp)
{
	...
	mStartButton = new PopLib::HyperlinkWidget(0, this);
	mStartButton->mColor = PopLib::Color(218, 184, 33);
	mStartButton->mOverColor = PopLib::Color(250, 90, 15);
...
//0x48E5A0
void TitleScreen::AddedToManager(PopLib::WidgetManager* theWidgetManager)
{
...
//0x48E5D0
void TitleScreen::RemovedFromManager(PopLib::WidgetManager* theWidgetManager)
{
