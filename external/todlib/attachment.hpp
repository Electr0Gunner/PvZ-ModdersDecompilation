...
public:
    ...
    void                    Update();
    void                    SetPosition(const Vector2& thePosition);
    void                    SetMatrix(const Transform2D& theMatrix);
...
/*inline*/ void             AttachmentUpdateAndSetMatrix(AttachmentID& theAttachmentID, Transform2D& theMatrix);
