...
class TodDSoundInstance : public OpenALSoundInstance
{
    friend class TodFoley;

public:
    TodDSoundInstance(OpenALSoundManager* theSoundManager, ALuint theSourceSound) : OpenALSoundInstance(theSoundManager, theSourceSound) { }
