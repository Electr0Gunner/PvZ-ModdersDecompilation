...
#define PIXEL_INCLUDE "PopLib/graphics/SWTri/SWTri_Pixel8888.cpp"
#define NAME0 8888
#elif (TRI0==1)
#define PTYPE unsigned long
#define PIXEL_INCLUDE "PopLib/graphics/SWTri/SWTri_Pixel888.cpp"
#define NAME0 0888
#elif (TRI0==2)
#define PTYPE unsigned short
#define PIXEL_INCLUDE "PopLib/graphics/SWTri/SWTri_Pixel565.cpp"
#define NAME0 0565
#elif (TRI0==3)
#define PTYPE unsigned short
#define PIXEL_INCLUDE "PopLib/graphics/SWTri/SWTri_Pixel555.cpp"
#define NAME0 0555
#endif
...
#define funcname2additive(t0,t1,t2,t3,t4,t5) TodDrawTriangle_##t0##_##t1##_##t2##_##t3##_##t4##_##t5##_ADDITIVE
#define funcname1additive(t0,t1,t2,t3,t4,t5) funcname2additive(t0,t1,t2,t3,t4,t5)
#define funcnameadditive funcname1additive(NAME0,NAME1,NAME2,NAME3,NAME4,NAME5)
#define funcname2(t0,t1,t2,t3,t4,t5) TodDrawTriangle_##t0##_##t1##_##t2##_##t3##_##t4##_##t5
#define funcname1(t0,t1,t2,t3,t4,t5) funcname2(t0,t1,t2,t3,t4,t5)
#ifdef NAME_ADDITIVE
#define funcname funcname1additive(NAME0,NAME1,NAME2,NAME3,NAME4,NAME5)
#else
...
void	funcname(SWHelper::SWVertex* pVerts, void* pFrameBuffer, const unsigned int bytepitch, const SWHelper::SWTextureInfo* textureInfo, SWHelper::SWDiffuse& globalDiffuse)
{
	...
	if (gTodTriangleDrawAdditive)
	{
		...
		funcnameadditive(pVerts, pFrameBuffer, bytepitch, textureInfo, globalDiffuse);
#endif
		return;
	}
#endif
...
#include <PopLib/graphics/SWTri/SWTri_Loop.cpp>
			}
		}
		else if (mid > v1->x)
		{
...
#undef funcname2additive
#undef funcname1additive
#undef funcnameadditive
#undef funcname2
#undef funcname1
#undef funcname
#undef PTYPE
